...
fn find(g: &Guest, id: u32) -> Result<u32> {
...
fn descriptor(g: &mut Guest, at: u32, arg: u32, class: u32, channels: u8) -> Result<()> {
    g.set_u32(at, arg)?;
...
fn route(g: &mut Guest, block: u32, send: u32, target: u32) -> Result<()> {
